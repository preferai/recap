...
class dataset(object):
    def __init__(self,filename,opt):
        self.entity2entityId=pkl.load(open('data/kgsf/entity2entityId.pkl','rb'))
        self.entity_max=len(self.entity2entityId)

        self.id2entity=pkl.load(open('data/kgsf/id2entity.pkl','rb'))
        self.subkg=pkl.load(open('data/kgsf/subkg.pkl','rb'))    #need not back process
        self.text_dict=pkl.load(open('data/kgsf/text_dict.pkl','rb'))
...
if __name__=='__main__':
    ds=dataset('data/kgsf/train_data.jsonl')
    print()
